...
azecure = LINETCR.LINE() # az # Login Pake Akun Utama (Akun Utama Ke Kick bisa Terima Undangan dari Bot Otomatis)
        ...
        if op.type == 11:
          if wait["Protectgr"] == True:
            if op.param2 not in Bots:
              ...
              random.choice(KAC).sendText(op.param1,random.choice(KAC).getContact(op.param2).displayName + "Please,,,Dont Open Link or QR Codes")
...
#--------------------------------
    ...
    #--------------- SC Add Admin ---------
		...
		gs = kk.getGroup(msg.to)                
              ...
              if admin == []:
                  cl.sendText(msg.to,"Admin Controler is empty")
              else:
                  cl.sendText(msg.to,"Please wait...")
                  mc = "zilentwish Bot Admin Control:\n"
                  for mi_d in admin:
    ...
    #-----------------=Selesai=------------------
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Qr Codes already Opened")
                else:
                    if wait["lang"] == "JP":
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Qr Codes already opend")
                else:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Can not be used outside the group")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Qr Codes already Opened")
                else:
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Can not be used outside the group")
                    else:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    random.choice(KAC).updateGroup(X)
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Qr Codes has been Closed")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Not for use less than group")
            elif msg.text in ["x1 close qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    ki.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Done,,, Qr Codes has closed")
                    else:
                        ki.sendText(msg.to,"Qr Codes already closed")
                else:
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Can not be used outside the group")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        kk.sendText(msg.to,"Done,,, Qr Codes has closed")
                    else:
                        kk.sendText(msg.to,"Qr Codes already closed")
                else:
                    if wait["lang"] == "JP":
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
				...
				cl.sendText(msg.to,"Done,, join group success %s" % str(group.name))
              ...
              if msg.from_ in admin:
                if wait["Protectcancl"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Cancel all invitations On")
                    else:
                        cl.sendText(msg.to,"Done")
                else:
              ...
              if msg.from_ in admin:
                if wait["Protectcancl"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Cancel all invitations Off")
                    else:
                        cl.sendText(msg.to,"Done")
                else:
              ...
              if msg.from_ in admin:
                if wait["Protectgr"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Protect QR Codes On")
                    else:
                        cl.sendText(msg.to,"Done, Protect QR Codes On")
                else:
                    wait["Protectgr"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Protect QR Codes On")
              ...
              if msg.from_ in admin:
                if wait["Protectgr"] == False:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Done, Protect QR Off")
                else:
              ...
              if msg.from_ in admin:
                if wait["contact"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Cek Mid via Share contact On")
                    else:
                        cl.sendText(msg.to,"Done, Cek Mid via Share contact On")
                else:
                    wait["contact"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Cek Mid via Share contact On")
              ...
              if msg.from_ in admin:
                if wait["contact"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Cek Mid via Share contact Off")
                    else:
                        cl.sendText(msg.to,"Done, Cek Mid via Share contact Off")
                else:
                    wait["contact"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Cek Mid via Share contact Off")
              ...
              if msg.from_ in admin:
                if wait["autoJoin"] == True:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Done, Auto join On")
                else:
                    wait["autoJoin"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Auto join On")
              ...
              if msg.from_ in admin:
                if wait["autoJoin"] == False:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Done, Auto join Off")
                else:
                    wait["autoJoin"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Auto join Off")
              ...
              if msg.from_ in admin:
                if wait["leaveRoom"] == True:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Done, Auto leave On")
                else:
                    wait["leaveRoom"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done, Auto leave On")
              ...
              if msg.from_ in admin:
                if wait["leaveRoom"] == False:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Done, Auto leave Off")
                else:
		...
		cl.sendText(msg.to,md)
              ...
              if msg.from_ in admin:
                if wait["autoAdd"] == True:
                    ...
                    wait["autoAdd"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done, Auto add already On")
                    else:
                        cl.sendText(msg.to,"è¦�äº†å¼€ã€‚")
              ...
              if msg.from_ in admin:
                if wait["autoAdd"] == False:
                    ...
                    wait["autoAdd"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done, Auto add already Off")
                    else:
                        cl.sendText(msg.to,"è¦�äº†å…³æ–­ã€‚")
...
#--------===---====--------------
              ...
              if msg.from_ in admin:
                if wait["commentOn"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done, Comment On")
                    else:
                        cl.sendText(msg.to,"Comment already On")
                else:
                    wait["commentOn"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done, Comment already On")
                    else:
                        cl.sendText(msg.to,"è¦�äº†å¼€ã€‚")
            elif msg.text in ["ã‚³ãƒ¡ãƒ³ãƒˆ:ã‚ªãƒ•","Comment off","è‡ªå‹•é¦–é �ç•™è¨€ï¼šé—œ"]:
                if wait["commentOn"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done, Comment Off")
                    else:
                        cl.sendText(msg.to,"Comment already Off")
                else:
                    wait["commentOn"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done, Comment already Off")
                    else:
                        cl.sendText(msg.to,"è¦�äº†å…³æ–­ã€‚")
            elif msg.text in ["Comment","ç•™è¨€ç¢ºèª�"]:
                cl.sendText(msg.to,"message changes to\n\n" + str(wait["comment"]))
        ...
        #-------------Fungsi Jam on/off Start-------------------#            
              ...
              if msg.from_ in admin:
                if wait["clock"] == True:
                    kk.sendText(msg.to,"Bot 3 hours On")
                else:
                    wait["clock"] = True
                    now2 = datetime.now()
              ...
              if msg.from_ in admin:
                if wait["clock"] == False:
                    kk.sendText(msg.to,"Bot 3 hours Off")
                else:
                    wait["clock"] = False
                    kk.sendText(msg.to,"Time is Off")
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Please, first Type command [Cek] \nand then Type Command[View]\nThank You")
#-----------------------------------------------
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
              ...
              if msg.from_ in owner:
                        ...
                        G.preventJoinByTicket = True
                        cl.updateGroup(G)
                        print "[Command]paraBot is Ready"
    ...
    #-------------Fungsi Tag All Finish---------------#
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if matched_list == []:
                        ...
                        random.choice(KAC).sendText(msg.to,"Please Don't Come Back OKey,,, ahhaaayyyyyyy")
                        return
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    random.choice(KAC).sendText(msg.to,"Blacklist Succes")
                                except:
        ...
        #-------------Fungsi Spam Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"Flood...!!!")
                ki.sendText(msg.to,"Flood...!!!")
                kk.sendText(msg.to,"Flood...!!!")
                cl.sendText(msg.to,"Flood...!!!")
                ki.sendText(msg.to,"Flood...!!!")
                kk.sendText(msg.to,"Flood...!!!")
                cl.sendText(msg.to,"Flood...!!!")
        ...
        #-------------Fungsi Broadcast Start------------#
            elif "Bc " in msg.text: #Broadcast Ke semua Group yang di Join bot
              if msg.from_ in owner:
      ...
      #--------------Fungsi Broadcast Finish-----------#
            ...
            elif msg.text in ["Lg"]: #cek bot ada di Group mana saja
              if msg.from_ in admin:
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Out all group"]: # parabot left Dari Semua Group Yang Di dalem nya  ada bot(Kalo ada Bot Nyangkut di Group lain)
              if msg.from_ in owner:
                 gid = cl.getGroupIdsJoined()
...
#-----------------------------------------------
      ...
      #-------------Fungsi Balesan Respon Start---------------------#
            elif msg.text in ["Ini Apa","ini apa","Apaan Ini","apaan ini,Ada apa,ada apa,"]:
                ki.sendText(msg.to,"Ya gitu deh intinya mah ,,,, aahhaaayyyy")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendText(msg.to,"====zilentwish====")
              cl.sendMessage(msg)
              #cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"Itu Creator Kami Yang Pea, Dudul ,Oneng, Pemalu, Pemahat, Pemaku, Penjahat, kudisan, Panuan, Kurapan, Buncit, Cacingan kribo, Hitam, Hidup lagi 😜")
                
      #-------------Fungsi Chat ----------------
            elif msg.text in ["bot","Bot"]:
                 quote = ['siap Bozz','Jelek lu','Istri yang baik itu Istri yang Mengizinkan Suaminya untuk Poligami 😂😂😂.','Kunci Untuk membuat Suami Bahagia itu cuma satu..\nIzinkan Suamimu punya tikungan tanjakan turunan','Ah Kamvret Lu','Muke gileeee','Ada Orang gak disini?']
...
#---------------------
        if op.type == 17:
           ...
           random.choice(KAC).sendText(op.param1, "Welcome to Group" + str(ginfo.name)+ " Group")
           ...
           print "[Command]Member has left the group"
        if op.type == 15:
           if op.param2 in Bots:
              return
