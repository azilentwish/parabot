...
satpam = LINETCR.LINE() # azeez1.2 # Login Pake Akun Utama Kalian(Gunanya Supaya Akun Utama Ke Kick bisa Terima Undangan dari Bot Otomatis)
...
=============="""
KAC=[cl,ki,kk]
DEF1=[ki,kk] #Udah Ga Kepake(Boleh di apus)
DEF2=[cl,kk] #Udah Ga Kepake(Boleh di apus)
DEF3=[cl,ki] #Udah Ga Kepake(Boleh di apus)
DEF4=[cl,ki,kk] #Udah Ga Kepake(Boleh di apus)
DEF5=[cl,ki,kk] #Udah Ga Kepake(Boleh di apus)
DEF6=[cl,ki,kk] #Udah Ga Kepake(Boleh di apus)
DEF7=[cl,ki,kk] #Udah Ga Kepake(Boleh di apus)
DEF8=[cl,ki,kk] #Udah Ga Kepake(Boleh di apus)
DEF9=[cl,ki,kk] #Udah Ga Kepake(Boleh di apus)
DEF10=[cl,ki,kk] #Udah Ga Kepake(Boleh di apus)
...
Minat? Silahkan PM!
Idline: http://line.me/ti/p/~a7nonym""",
    "lang":"JP",
...
#--------------------------------
    ...
    #-----------------=Selesai=------------------
            ...
            elif msg.text in ["x1 buka qr","x1 open qr"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["x2 buka qr","x2 open qr"]:
                if msg.toType == 2:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Not for use less than group")
            elif msg.text in ["x1 close qr","x1 tutup qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    ki.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["x2 tutup qr","x2 close qr"]:
                if msg.toType == 2:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                random.choice(KAC).sendText(msg.to,"SUKSES... Akun telah di banned")
                            except:
                                random.choice(KAC).sendText(msg.to,"Error")
