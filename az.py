...
azecure.login(token="En0Sswyhi5QEx414rNO6.1KAJPWzm3lsd3XhagT+FvG.KWL3KoGa2mZTnBJnVBYkT6Dfk75HgBmbVEVfXTBiAX4=")
azecure.loginResult()

cl = LINETCR.LINE() #x1
cl.login(token="EnF7HEsK274lYoVy8LUa.KMu+wB1O/CwcCXXEWFTykG./7HCar5u0/Wbn21B8CR+TVPD17gy1j2Xe6CWZo+shDQ=")
cl.loginResult()

ki = LINETCR.LINE() #x2
ki.login(token="En05zCXGCYbIkC42dgU1.cSsJLerQeQq8ELgJnnDFCq.f8VH2hEmt9zlgDwOrm9IG1QDyZthFrSK3ObpxnYw8hw=")
ki.loginResult()

kk = LINETCR.LINE() #x3
kk.login(token="EnYw3SkRG7Gc2MNJDFz2.DZTCG3zmgU3MSdew/UufSG.A+MdWTXarCl5jwXxdKjlXaKgGh4wgB9rtRVP/9K/KG8=")
kk.loginResult()

k1 = LINETCR.LINE() #x4 Backup 
k1.login(token="EnKivc6y7ejCN7ii17n1.Sjcr0qgLooEZ5Upv24W08q.wjReaC4g3I9z9bP7JroP4BqET5Dan5khvjVie5P7Ih4=")
k1.loginResult()
...
admin=["ud646a3a7064cdcb483df11c01adfdf56","u370d300e76e607da9ba4eed2870befe8","u5c867b91afa94b934acc3ef4c567fcb4","ucf11ea078a2a331f879f0176803983a6","u6d55a2a061b3edfd95b7e8144d8a25eb","ude02604ec5cb395174d2bad657deb8c0"] 
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Please Type command [Cek] to reset Point \nand then Type Command [View]\nThank You")
#-----------------------------------------------
...
#---------------------
        if op.type == 17:
           ...
           #random.choice(KAC).sendText(op.param1, "Creator Group " + str(ginfo.name) +" Group is"+ ":\n" + ginfo.creator.displayName)
